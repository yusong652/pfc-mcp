"""Generate the MPoint (MPM) Python SDK skeleton index.
...
Usage:
    uv run python scripts/corpus/generate_mpoint_python_skeleton.py
"""
...
def main() -> None:
    ...
    index = {
        "version": "1.0",
        "description": "MPoint (MPM) Python SDK documentation index (skeleton: shared itasca core only; engine-specific modules deferred)",
