...
from itasca_mcp.knowledge.search.legacy_models import DocumentType, SearchStrategy
from itasca_mcp.knowledge.search.legacy_models import SearchResult as CommandSearchResult
