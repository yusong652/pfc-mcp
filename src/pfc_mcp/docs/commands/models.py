...
from pfc_mcp.docs.search.legacy_models import DocumentType, SearchStrategy
from pfc_mcp.docs.search.legacy_models import SearchResult as CommandSearchResult
