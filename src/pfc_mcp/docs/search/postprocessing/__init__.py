...
from pfc_mcp.docs.search.postprocessing.component_consolidation import consolidate_component_apis
from pfc_mcp.docs.search.postprocessing.contact_consolidation import consolidate_contact_apis
