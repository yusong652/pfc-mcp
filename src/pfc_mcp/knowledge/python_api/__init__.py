...
Usage:
    from pfc_mcp.knowledge.python_api import (
        DocumentationLoader,
        APIDocFormatter
    )
...
Note:
    ...
    - pfc_mcp.knowledge.query.APISearch (BM25-based search)
"""
...
from pfc_mcp.knowledge.python_api.models import APIDocumentation, SearchResult, SearchStrategy
